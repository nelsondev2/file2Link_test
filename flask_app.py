    ...
    <body>
        <div class="container">
            ...
            <div class="info-section">
                ...
                <p>• Los hashes expiran después de {file_service.HASH_EXPIRE_DAYS} días</p>
...
Hash de seguridad: 12 caracteres, {file_service.HASH_EXPIRE_DAYS} días de validez
...
def system_status():
    ...
    return jsonify({
        ...
        "security": {
            "hash_enabled": True,
            "hash_expire_days": file_service.HASH_EXPIRE_DAYS,
...
def api_stats():
    ...
    return jsonify({
        ...
        "security": {
            ...
            "expire_days": file_service.HASH_EXPIRE_DAYS
        },
        "system": {
